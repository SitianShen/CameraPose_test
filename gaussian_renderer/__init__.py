...
from .calc_2d_coord import transform_points, calculate_depths, process_coordinates, find_deepest_3d_points
from .draw_points import draw_2ddrag_point
...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    ...
    # for pixel, pts in pixel_to_3dpoints.items():
    #     if pts:  # pixel paired with pts not none
    #         print(f"Pixel {pixel} corresponds to 3D points: {pts}")

    # find the front 3d point of 2d images
    # deepest_3dpoints_per_pixel = find_deepest_3d_points(pixel_to_3dpoints, depths_3dpoints)

    # for pixel, point in deepest_3dpoints_per_pixel.items():
    #     print(f"Deepest 3D point at pixel {pixel} is {point}")
    ...
    # res = rasterizer.markVisible(torch.tensor([1.,2.,3.]))
    # print(type(res))
    # print(res)
    # exit()
